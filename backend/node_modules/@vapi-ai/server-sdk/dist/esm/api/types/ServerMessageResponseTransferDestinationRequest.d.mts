...
export declare namespace ServerMessageResponseTransferDestinationRequest {
    /**
     * This is the destination you'd like the call to be transferred to.
     */
     ...
     * This is the message that will be spoken to the user as the tool is running.
     */
    type Message = Vapi.ToolMessageStart | Vapi.ToolMessageComplete | Vapi.ToolMessageFailed | Vapi.ToolMessageDelayed;
}
