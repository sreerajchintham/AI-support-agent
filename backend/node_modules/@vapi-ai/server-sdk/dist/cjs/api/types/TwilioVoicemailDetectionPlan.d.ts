...
export declare namespace TwilioVoicemailDetectionPlan {
    type VoicemailDetectionTypes = VoicemailDetectionTypes.Item[];
    namespace VoicemailDetectionTypes {
        type Item = "machine_start" | "human" | "fax" | "unknown" | "machine_end_beep" | "machine_end_silence" | "machine_end_other";
        const Item: {
